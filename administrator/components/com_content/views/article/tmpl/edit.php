			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="general">
					<fieldset class="adminform">
						...
						<div class="control-group form-inline">
							<?php echo $this->form->getLabel('intro_images'); ?> <?php echo $this->form->getInput('intro_images'); ?>
						</div>
						...
						<?php if ($introImages): ?>
						<div class="control-group form-inline">
							<?php echo $this->form->getLabel('del_image'); ?> <?php echo $this->form->getInput('del_image'); ?>
						</div>
						<?php endif; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<a href="<?php echo JUri::root() . $introImages; ?>" class="modal">
							<img src="<?php echo JUri::root() . $introImages; ?>" width="100" />
						</a>
					</div>
				</div>
				<?php endif; ?>
